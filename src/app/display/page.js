...
export default function DisplayBoardSelect() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 bg-slate-900 text-white">
            <div className="text-center mt-8 sm:mt-16 mb-8 sm:mb-16">
                <h1 className="text-3xl sm:text-5xl font-black mb-4 tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">
                    Interview Display Boards
                </h1>
                <p className="text-slate-400 text-base sm:text-xl font-medium">Select a room to launch the public display interface.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 w-full max-w-6xl">
                {rooms.map(room => (
                    ...
                    >
                        <div className="bg-slate-900 rounded-[calc(1.5rem-1px)] p-6 sm:p-10 h-full flex flex-col items-center text-center">
